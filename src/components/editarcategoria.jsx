...
const EditarCategoria = ({ onCancel }) => {
  ...
  const fetchCategorias = async () => {
    try {
      const responseCategorias = await fetch('https://pedidosbak-production.up.railway.app/producto/listar_categorias/');
      const dataCategorias = await responseCategorias.json();

      const responseTiposProductos = await fetch('https://pedidosbak-production.up.railway.app/producto/listarproductos/');
  ...
  const eliminartp = async (idca) => {
    try {
      ...
      const response = await fetch(`https://pedidosbak-production.up.railway.app/producto/editar_categoria/${idca}/`, {
        method: 'POST',
        body: formData,
      });
